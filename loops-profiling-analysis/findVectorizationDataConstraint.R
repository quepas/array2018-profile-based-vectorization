source("findLast.R")
data <- read.csv("../../benchmarks-instrumented/paper-results/loops-final/spmv1_2015b.csv", header = FALSE);
...
##cat(sprintf("[LCPC]\n\tNaive constraint: %f\n", positiveLCPC[1]))
#cat(sprintf("\tBetter constraint: %f\n", data$sample[lastLCPC]))
